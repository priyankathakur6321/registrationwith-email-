...
from accounts.models import UserProfile, content_db
...
class contentSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        rep = super(contentSerializer, self).to_representation(instance)
        rep['assigen_to'] = instance.assigen_to.username
